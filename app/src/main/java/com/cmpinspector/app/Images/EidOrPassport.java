...
public class EidOrPassport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eid_or_passport);

        String url=getIntent().getStringExtra("image");

        scaleGestureDetector = new ScaleGestureDetector(this, new ScaleListener());

        imageView=findViewById(R.id.eid_or_passport_img);
        imageView1= findViewById(R.id.deed_back_icon);
        imageView1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EidOrPassport.this,BasicDetails1Activity.class);
